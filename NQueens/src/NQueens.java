...
public class NQueens 
{
     ...
     * @param dimensionOfChessBoard : to give dimention of chess board
     * @return returns : true if specified position is safe or false if specified position is not safe
     */
    public boolean checkIfPossible(int[][] board,int row,int column,int dimensionOfChessBoard)
    { 
        chessBoard=board;
        for(int i=0;i<row;i++)
        {
     ...
     * @param startRow : starting row of elements
     * @param dimensionOfChessBoard : dimension of matrix
     * @return true/false
     */
    ...
    public boolean nOueen(int[][] board,int startRow,int dimensionOfChessBoard)
    {
        ...
        {
            if(checkIfPossible(chessBoard,startRow,i,dimensionOfChessBoard)) 
            { 
